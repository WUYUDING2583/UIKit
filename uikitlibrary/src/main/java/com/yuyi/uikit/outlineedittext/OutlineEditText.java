...
public class OutlineEditText extends LinearLayout {
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (attr == R.styleable.OutlineEditText_hint) {
            ...
            } else if (attr == R.styleable.OutlineEditText_titleVisibility) {
                ...
                setInputType(a.getInt(attr, InputType.TYPE_CLASS_TEXT));
            } else if (attr == R.styleable.OutlineEditText_titleBackground) {
                Drawable titleBackground = a.getDrawable(attr);
                setTitleBackground(titleBackground);
            } else if (attr == R.styleable.OutlineEditText_inputBackground) {
